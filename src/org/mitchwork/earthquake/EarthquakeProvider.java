...
public class EarthquakeProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI =
		Uri.parse("content://com.mitchwork.provider.earthquake/earthquakes");
	...
	public static final String KEY_MAGINTUDE = "magnitude";
	...
	// correspond to a request for all earthquakes, and 'eathquakes' with a 
	// trailing '/[rowID]' will represent a single earthquake row.
	static {
		uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
		uriMatcher.addURI("com.mitchwork.provider.Earthquake", "earthquakes", QUAKES);
		uriMatcher.addURI("com.mitchwork.provider.Earthquake", "earthquakes/#", QUAKE_ID);
	}
	
	@Override
	public String getType(Uri uri) {
		switch (uriMatcher.match(uri)) {
		case QUAKES: return "vnd.android.cursor.dir/vnd.mitchwork.earthquake";
		case QUAKE_ID: return "vnd.android.cursor.item/vnd.mitchwork.eathquake";
	...
	public Uri insert(Uri _uri, ContentValues _initialValues) {
		...
		long rowID = earthquakeDB.insert(EARTHQUAKE_TABLE, "quakes", _initialValues);
	...
	public int delete(Uri uri, String where, String[] whereArgs) {
		...
		default: throw new IllegalArgumentException("Unsupported UIR: " + uri);
		}
	...
	public int update(Uri uri, ContentValues values,
		...
		int count;
		switch (uriMatcher.match(uri)) {
		case QUAKES: count = earthquakeDB.update(EARTHQUAKE_TABLE, values, where, wArgs);
					break;
