...
public class EarthquakeProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI =
		Uri.parse("content://org.mitchwork.provider.earthquake/earthquakes");
	...
	public String getType(Uri uri) {
		...
		case QUAKE_ID: return "vnd.android.cursor.item/vnd.mitchwork.earthquake";
		default: throw new IllegalArgumentException("Unsupported URI: " + uri);
		}
	}
	...
	static {
		...
		uriMatcher.addURI("org.mitchwork.provider.Earthquake", "earthquakes", QUAKES);
		uriMatcher.addURI("org.mitchwork.provider.Earthquake", "earthquakes/#", QUAKE_ID);
	}
